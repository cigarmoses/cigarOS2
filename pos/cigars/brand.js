...
(() => {
  ...
  // ---- modal (matches your current look: Image coming soon, Close/Add to invoice) ----
  ...
  // ---- render rows (THIS is the key fix) ----
  function render() {
    if (!listEl) return;
    ...
    listEl.innerHTML = state.view
      .map((r) => {
        ...
        // LEFT stack lines exactly like your Padron example
        return `
          <div class="brand-row"
            data-row
